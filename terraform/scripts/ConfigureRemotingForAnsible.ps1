...
#Hashed as Conflicts with Group Policy
#If ($DisableBasicAuth)
#{
...
#Setting Registry Values to permit Pshell Remoting
...
Set-ItemProperty HKLM:\SYSTEM\CurrentControlSet\Control\Lsa\Credssp\PolicyDefaults\AllowDefaultCredentialsWhenNTLMOnlyDomain -Name WSMan -Value "WSMAN/*"
